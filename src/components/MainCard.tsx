...
const MainCard = () => {
  return (
    <div className="  h-full rounded-lg max-sm:bg-none max-sm:bg-gray-800 bg-mainCard bg-cover bg-no-repeat bg-bottom text-white flex flex-col p-7 space-y-5 font-light text-sm leading-loose  ">
            <p>
